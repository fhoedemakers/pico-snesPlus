...
/* Second copy of the 65C816 interpreter, compiled for the SA-1 coprocessor.
 * The #defines below redirect CPU/ICPU state, memory accessors, opcode tables
 * and addressing modes to their SA1* variants, then cpuops.c is included with
 * SA1_OPCODES defined so the whole opcode core is regenerated for the SA-1. */
